...
const {search, getProductsByIds} = require('./api/search');
...
exports = module.exports = app => { // eslint-disable-line max-statements
    ...
    app.get('/static-page/:slug', routes.views['static-page']);
    ...
    app.get('/api/get-products-by-ids/:list', getProductsByIds);
