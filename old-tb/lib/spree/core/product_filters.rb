  ...
  module Core
    ...
    module ProductFilters
      ...
      def ProductFilters.price_filter
        ...
        conds = [ [ Spree.t(:under_price, price: format_price(10000)),    v[:amount].lteq(10000)],
                  [ "#{format_price(10000)} - #{format_price(50000)}",    v[:amount].in(10000..50000)],
                  [ "#{format_price(50000)} - #{format_price(100000)}",   v[:amount].in(50000..100000)],
                  [ "#{format_price(100000)} - #{format_price(250000)}",  v[:amount].in(100000..250000)],
                  [ Spree.t(:or_over_price, price: format_price(250000)), v[:amount].gteq(250000)]]
        {
